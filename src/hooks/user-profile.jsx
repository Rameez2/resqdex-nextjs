...
export default function UserProfile() {
  ...
  return (
    <div
      className="min-h-screen bg-[#fbf5f0] flex justify-center items-center p-4">
      <div
        className="w-full max-w-3xl bg-white rounded-xl overflow-hidden shadow-sm">
        {/* Header gradient */}
        ...
        <div className="px-8 py-6">
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <div className="relative">
                <select
                  className="w-full bg-[#f9f9f9] border-0 rounded-lg h-10 px-3 appearance-none">
          ...
          <div className="mt-8">
            ...
            <div className="flex items-center gap-3 mb-3">
              <div
                className="w-10 h-10 rounded-full bg-[#f9f9f9] flex items-center justify-center">
            ...
            <button
              className="mt-4 inline-flex items-center text-[#292d32] bg-[#fbf5f0] px-4 py-2 rounded-lg">
              + Add Email Address
            </button>
          </div>
