...
const OrgDetailsComp = ({ orgData }) => {
    ...
    const animalsList = [
        ...
        { name: "Cats", available: true },
        { name: "Horses", available: true },
        { name: "Pigs", available: true },
        { name: "Pocket Pets", available: true },
        { name: "Rabbits", available: true },
        { name: "Small & Furry", available: true },
        { name: "Birds", available: true },
        { name: "Exotics", available: true },
        { name: "Farm", available: true },
                ...
                <div className="max-w-7xl mx-auto">
                                    ...
                                    <div>
                                        ...
                                        <div className="grid grid-cols-2 gap-3">
                                            {animalsList.map((animal, index) => (
                                                <div
                                                    key={index}
                                                    className={`flex items-center justify-between px-3 py-2 rounded-lg text-sm font-medium ${orgData.adopted_out[index]
                                                            ? "bg-green-100 text-green-800 border border-green-200"
                                                            : "bg-gray-100 text-gray-600 border border-gray-200"
                                                        }`}
                                                >
                                                    <span>{animal.name}</span>
                                                    {orgData.adopted_out[index] ? (
                                    ...
                                    <div className="border-t border-gray-200 pt-4">
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                            <div className="bg-green-50 p-3 rounded-lg border border-green-200">
                                                ...
                                                <p className="text-xl font-bold text-green-800">${orgData.adoption_fees[0]}</p>
                                            </div>
                                            <div className="bg-blue-50 p-3 rounded-lg border border-blue-200">
                                                <p className="text-sm text-blue-600 font-medium">Lowest Fee</p>
                                                <p className="text-xl font-bold text-blue-800">${orgData.adoption_fees[1]}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="grid grid-cols-2 gap-6">
                                        <div>
                                            ...
                                            <div className="bg-orange-50 p-4 rounded-lg border border-orange-200 text-center">
                                                <p className="text-3xl font-bold text-orange-800">{orgData.current_animals}</p>
                                        ...
                                        <div>
                                            ...
                                            <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                                                <p className="text-gray-700 text-sm">
                                                    <a
                                                        href={storage.getFileView("6799fb94000edc47b27d", orgData.adoption_contract)}
                                                        target="_blank"
                                    ...
                                    <div>
                                        ...
                                        <div className="space-y-2 text-gray-700 text-sm">
                                            <div className="flex items-start">
                                                ...
                                                <p>{orgData.medical_adoption[0]}</p>
                                            </div>
                                            <div className="flex items-start">
                                                {orgData.medical_adoption[1] === "yes-always" ?
                                                    <svg
                                                        className="w-4 h-4 text-green-500 mr-2 mt-0.5 flex-shrink-0"
                                                        fill="none"
                                                        stroke="currentColor"
                                                ...
                                                <p>{orgData.medical_adoption[1]}</p>
                                            </div>
                                            <div className="flex items-start">
                                                <svg
                                                    className="w-4 h-4 text-green-500 mr-2 mt-0.5 flex-shrink-0"
                                                ...
                                                <p>{orgData.medical_adoption[2]}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100 mt-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                            {orgData.online_presence.map((link, index) => (
                                <a
                                    key={index}
                                    href={link}
                                    target="_blank"
